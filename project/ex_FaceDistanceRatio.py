...
class FaceDistanceRatio:
    ...
    def right_eye_shape(self, a='39', b='36'):
        self.a = self.dictionary[a]
        self.b = self.dictionary[b]
        if abs(self.a[1] - self.b[1]) <= 3:
            return 'middle'
        else:
            if self.a[1] - self.b[1] < -3:
                return 'down'
            else:
                return 'up'
    # 왼쪽 눈꼬리의 높낮이
    ...
    def mouth_shape(self, a='48', b='54', c='62', d='66'):
        ...
        if abs(mid_ab_y - mid_cd_y) <= 3:
            return 'middle'
        else:
            if mid_ab_y - mid_cd_y < -3:
                return 'down'
            else:
                return 'up'
    ...
    def info(self):
        ...
        print('입고리의 모양:', self.mouth_shape())
        print('하관 비:', self.jaw_height())



if __name__ == '__main__':
    diction = {"0": [88, 225], "1": [90, 257], "2": [93, 289], "3": [98, 321], "4": [106, 351], "5": [123, 378], "6": [144, 402], "7": [170, 420], "8": [199, 425], "9": [227, 420], "10": [252, 402], "11": [274, 379], "12": [290, 352], "13": [299, 323], "14": [306, 292], "15": [311, 260], "16": [312, 228], "17": [105, 212], "18": [118, 197], "19": [139, 195], "20": [159, 199], "21": [178, 208], "22": [215, 207], "23": [234, 199], "24": [254, 195], "25": [275, 198], "26": [290, 213], "27": [196, 232], "28": [196, 255], "29": [196, 277], "30": [195, 301], "31": [173, 311], "32": [183, 314], "33": [195, 318], "34": [207, 314], "35": [219, 310], "36": [129, 233], "37": [140, 227], "38": [154, 228], "39": [165, 237], "40": [152, 238], "41": [139, 237], "42": [228, 237], "43": [239, 228], "44": [253, 227], "45": [265, 234], "46": [254, 238], "47": [240, 238], "48": [153, 342], "49": [169, 337], "50": [184, 333], "51": [196, 336], "52": [208, 333], "53": [223, 336], "54": [242, 341], "55": [224, 357], "56": [209, 365], "57": [196, 367], "58": [183, 365], "59": [168, 357], "60": [160, 344], "61": [184, 345], "62": [196, 346], "63": [208, 345], "64": [234, 343], "65": [208, 346], "66": [196, 348], "67": [184, 346]}
